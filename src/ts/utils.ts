import {
  ...
  import { LinearVestingEscrowLogicContract, LinearVestingEscrowLogicContractArtifact } from '../artifacts/LinearVestingEscrowLogic.js';
  import { EscrowContract, EscrowContractArtifact } from '@defi-wonderland/aztec-standards/current/artifacts/Escrow.js';
   ...
   * @returns A deployed contract instance.
   */
  export async function deployLinearVestingEscrow(deployer: AccountWallet, escrowClassId: Fr, options?: DeployOptions) {
    const contract = await Contract.deploy(
      deployer,
